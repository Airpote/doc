...
AmiChain is an L1 deployment and L1 nodes hosting service that originates from the AMI (Avax Meme Index) project, which created an index of major meme coins on the Avalanche network.  
...
For more information about deploying an L1 with AmiChain, visit [amichain.org/deploy](https://www.amichain.org/deploy).

## What to expect?

On the current website, additionally to the documentation of our existing tools, you will find an overview of our planned projects.  
